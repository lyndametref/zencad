...
r0 = rod(200, 1, ax=(0,1,0))
r1 = rod(200, 1, ax=(0,0,1))
r2 = rod(200, 1, ax=(0,1,0))

mass = mass()
rot = zencad.mbody.kinematic.rotator(ax=(0,1,0))
rot.link(r0.input)
...
pntarr = [(500,0,0), (500,0,100), (400,150,100), (300,150,100), (400,0,0)] 
...
starttime = time.time() 
lasttime = time.time()
chain = zencad.mbody.kinematic.kinematic_chain(mass)
iteration = 0
def animate(wdg):
	global tmodel
	global lasttime
