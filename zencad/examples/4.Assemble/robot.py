...
class Robot(zencad.assemble.unit):
    ...
    def __init__(self):
        ...
        self.left_arm_connector = zencad.mbody.kinematic.spherical_rotator(parent=self, location=mirrorYZ() * arm_translate)
        self.right_arm_connector = zencad.mbody.kinematic.spherical_rotator(parent=self, location=arm_translate)
        ...
        # print("HEAD_CONNECTOR!!!")
        self.head_connector = zencad.mbody.kinematic.rotator(parent=self, location=up(self.h), ax=(0,0,1))
